...
public class student {
    ...
    public boolean isStudentExist(String first,String last,String phone)
   {
       boolean isExist = false;
       Connection con = MyConnection.getConnection();
        PreparedStatement ps;
        try {
            ps = con.prepareStatement("SELECT * FROM `student` WHERE `first_name` = ? AND `last_name` = ? AND `phone` = ?");
